  ...
  const products = [
    {
      ...
      icon: '⚙️',
      title: 'Configure',
      subtitle: 'DfMA-optimized designs ready in minutes.',
      badge: 'PHASE 1: DESIGN',
    ...
    },
    {
      ...
      icon: '💰',
      title: 'Budget',
      subtitle: 'Accurate pricing with budget certainty.',
      badge: 'PHASE 2: PRICING',
    ...
    },
    {
      ...
      icon: '🏗️',
      title: 'Build',
      subtitle: 'Coordinated execution with pre-aligned partners.',
