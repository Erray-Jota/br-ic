  ...
  const products = [
    {
      ...
      icon: '🎯',
      title: 'Step 1',
      subtitle: 'Design is conceptual design in industrial unified framework.',
      badge: 'DESIGN',
    ...
    },
    {
      ...
      icon: '💰',
      title: 'Step 2',
      subtitle: 'Budget with accurate pricing and cost certainty.',
      badge: 'BUDGET',
    ...
    },
    {
      ...
      icon: '📋',
      title: 'Step 3',
      subtitle: 'Manage execution with coordination and alignment.',
      badge: 'MANAGE',
