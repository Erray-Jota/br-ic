...
const createDefaultProject = (name = 'New Project') => ({
  ...
  targets: { twoBedroom: 48, fourBedroom: 24 },
  optimized: { twoBedroom: 48, fourBedroom: 24 },
  length: 280.0,
...
export const ProjectProvider = ({ children }) => {
  ...
  const [projects, setProjects] = useState([
    {
      ...createDefaultProject('Cannon Air Force Base'),
      id: '1',
      targets: { twoBedroom: 48, fourBedroom: 24 },
      propertyLocation: 'Clovis, NM',
      propertyFactor: 0.85,
      propertyCoordinates: { lat: 34.3855, lng: -103.3370 },
      factoryLocation: 'Boise, ID',
      factoryFactor: 0.95,
      factoryCoordinates: { lat: 43.6150, lng: -116.2023 },
    },
    {
      ...createDefaultProject('Fort Hood'),
      id: '2',
      floors: 3,
      targetLength: 280,
      targets: { twoBedroom: 48, fourBedroom: 24 },
      propertyLocation: 'Killeen, TX',
      propertyFactor: 0.88,
      propertyCoordinates: { lat: 31.1218, lng: -97.3453 },
      factoryLocation: 'Boise, ID',
      factoryFactor: 0.95,
      factoryCoordinates: { lat: 43.6150, lng: -116.2023 },
    },
    {
      ...createDefaultProject('Naval Station Norfolk'),
      id: '3',
      floors: 3,
      targetLength: 280,
      commonAreaType: 2,
      targets: { twoBedroom: 48, fourBedroom: 24 },
      propertyLocation: 'Norfolk, VA',
      propertyFactor: 1.05,
      propertyCoordinates: { lat: 36.9349, lng: -76.3605 },
      factoryLocation: 'Boise, ID',
      factoryFactor: 0.95,
      factoryCoordinates: { lat: 43.6150, lng: -116.2023 },
    },
